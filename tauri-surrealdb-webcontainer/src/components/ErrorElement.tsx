...
export default function ErrorPage() {
  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center bg-[radial-gradient(circle_at_center,#2a2a2a_0%,#1a1a1a_100%)] text-white p-8 font-sans text-center">
      <div className="bg-white/5 backdrop-blur-[10px] border border-white/10 p-12 rounded-[20px] shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] max-w-[600px] w-full animate-in fade-in slide-in-from-bottom-5 duration-500">
        <span className="text-[4rem] mb-4 block animate-bounce">⚠️</span>
        ...
        <button
          className="bg-gradient-to-r from-[#4facfe] to-[#00f2fe] text-[#1a1a1a] border-none py-4 px-8 text-[1.1rem] font-semibold rounded-[50px] cursor-pointer transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-[0_5px_15px_rgba(79,172,254,0.4)] inline-block"
